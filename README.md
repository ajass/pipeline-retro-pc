...
**Purpose:** Build a retro PC capable of multi-booting DOS 6.22, Windows 98 SE, BeOS R5 Pro (with BONE network stack), Windows XP, and Debian Linux from a single 128GB IDE drive using BootIt Bare Metal as the boot manager.
