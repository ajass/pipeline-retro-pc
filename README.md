...
**Purpose:** Build a retro PC capable of multi-booting Windows 98 SE (with DOS 7.1 for DOS gaming), BeOS R5 Pro (with BONE network stack), Windows Server 2003 R2 (converted to gaming workstation), and Debian Linux from a single 128GB IDE drive using BootIt Bare Metal as the boot manager.
